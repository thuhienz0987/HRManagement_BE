...
import {create_user, verifyEmailUser,change_password, edit_user_profile, get_all_user, get_user_by_id} from '../controllers/userController.js';
...
router.post('/change-password/:_id', isValidResetToken, change_password);
