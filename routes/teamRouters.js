...
teamRouter.get('/team/:_id',getTeam);
...
teamRouter.put('/team/:_id',verifyRoles(ROLES_LIST.HRManager),updateTeam);
teamRouter.delete('/team/:_id',verifyRoles(ROLES_LIST.HRManager),deleteTeam);
